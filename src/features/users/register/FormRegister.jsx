...
export default function RegisterDesign({
  ...
  const otpButtonBaseClass =
    "flex items-center justify-center gap-2 rounded-2xl border px-5 py-3.5 text-sm font-semibold transition-all duration-200";

  return (
    <div
      dir="rtl"
      className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-sky-50 via-blue-100 to-indigo-200 px-4 py-8 font-sans sm:px-6 lg:px-8"
    >
      ...
      <div className="relative w-full max-w-xl">
        ...
        <div className="rounded-[2rem] border border-white/60 bg-white/90 px-6 py-8 shadow-[0_25px_80px_rgba(15,23,42,0.18)] backdrop-blur-xl sm:px-10 md:px-12 md:py-10">
          <div className="mb-8 text-center sm:mb-10">
            <div className="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 shadow-[0_18px_30px_rgba(37,99,235,0.35)]">
            ...
            <p className="mx-auto max-w-sm text-xs leading-6 text-slate-500 sm:text-sm">
              اطلاعات شما محفوظ می‌ماند و فقط برای ارسال کد تأیید استفاده می‌شود.
            </p>
          </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-blue-50/60 p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <button
                    ...
                    className={`${otpButtonBaseClass} ${preferredOtpTarget === "email"
                  ...
                  <button
                    ...
                    className={`${otpButtonBaseClass} ${preferredOtpTarget === "phone"
                        ? "border-blue-600 bg-blue-600 text-white shadow-lg"
                        : "bg-white text-slate-600 hover:border-blue-200 hover:text-blue-700"
                      }`}
                  >
